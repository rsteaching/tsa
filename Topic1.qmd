...
*Introductory video — available in the online (HTML) version of these notes.*
:::
...
::: {.video-card .content-visible when-format="html"}
**Estimation under Instability** <video autoplay muted playsinline loop> <source src="StructuralBreak.mp4" type="video/mp4"> </video>
:::

::: {.content-visible when-format="pdf"}
*Estimation under Instability — animation available in the online (HTML) version.*
:::
::::
...
::: {.content-visible when-format="pdf"}
*Time vs. Frequency Domains — animation available in the online (HTML) version.*
:::
::::
------------------------------------------------------------------------
...
::: slide-body
::: {.audio .content-visible when-format="html"}
audio/intro.mp3
:::
